...
├── forgot-password.html     # Step 1: User enters email to request reset link
├── forgot-password.js       # Validates email, generates token, demo simulation
├── reset-password.html      # Step 2: User sets new password after clicking link
├── reset-password.js        # Token validation, strength meter, password update
